...
class Settings(BaseSettings):
    database_url: str = "postgresql+asyncpg://stock_tracer:stock_tracer_dev@localhost:5432/stock_tracer"
    database_url_sync: str = "postgresql://stock_tracer:stock_tracer_dev@localhost:5432/stock_tracer"
...
if os.getenv("ENV", "development").lower() in ("production", "prod") and settings.secret_key == _DEV_SECRET_KEY:
    raise RuntimeError(
